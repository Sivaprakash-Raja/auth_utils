...
exports.ConstructLoginURL = void 0;
...
var ConstructLoginURL = function (tenantName, redirectURI, policyName, clientID, scope) {
    var encoded_uri = encodeURI(redirectURI);
    var nonce = (0, crypto_1.randomBytes)(16).toString('base64');
...
exports.ConstructLoginURL = ConstructLoginURL;
